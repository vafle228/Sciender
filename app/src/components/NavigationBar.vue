<template>
    <div :class="`${nav_class}`">
        <img src="@/assets/logos/logo.png" class="desktopNavigation__logo" v-if="!is_mobile">
        <a
            @click="$router.push({'name': 'user_info', params: {'id': id}})"
            :class="`${nav_class}__link ${active === 'profile' ? 'active' : ''}`"
        >
        ...
        <a 
            ...
            :class="`${nav_class}__link ${active === 'main' ? 'active' : ''}`"
        >
...
<script>
    ...
    export default {
        ...
        computed: {
            nav_class() { return this.is_mobile ? "mobileNavigation" : "desktopNavigation"; }
        }
    }
</script>

<style src="@/assets/stylesheets/MobileNavigation.css"/>
<style src="@/assets/stylesheets/DesktopNavigation.css"/>
