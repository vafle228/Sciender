<template>
    <main class="container" v-if="user">
        ...
        <div class="page">
            ...
            <div class="tabs">
                <StandartTab text="Информация" @click="$router.push({'name': 'user_info', params: {'id': $route.params.id}})"/>
                <StandartTab :active="true" text="Проекты" @click="$router.push({'name': 'projects_info', params: {'id': $route.params.id}})"/>
            </div>
...
<script>
    ...
    export default {
        ...
        beforeMount() {
            axios.get(PROJECTS_INFO(this.$route.params.id))
                .then((response) => {
...
<style src="@/assets/stylesheets/ProjectCard.css" />
